...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.sidecarPxpipeGetState]: AuthOrchestrationReadScope,
  [WS_METHODS.sidecarPxpipeGetStats]: AuthOrchestrationReadScope,
  [WS_METHODS.sidecarPxpipeSetRunning]: AuthOrchestrationOperateScope,
  [WS_METHODS.sidecarPxpipeRemoveCache]: AuthOrchestrationOperateScope,
