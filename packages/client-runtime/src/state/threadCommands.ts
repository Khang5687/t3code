...
import {
  ...
  type SendQueuedThreadTurnInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  const commands = {
    ...
    sendQueuedTurn: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:send-queued-turn",
      execute: (input: SendQueuedThreadTurnInput) => sendQueuedThreadTurn(input),
      scheduler,
      concurrency,
    }),
